---
title: "Working with Twitter Text"
author: "Paul Nulty"
...
In this module we will cover the following methods for mining and analyzing text from the twitter API:
...
* Analysing and visualizing the resulting text and metadata
